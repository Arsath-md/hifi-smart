      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 ">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`relative rounded-[35px] border p-8 backdrop-blur-xl transition duration-500 hover:-translate-y-2 ${
                plan.highlight
            ...
            >
              {/* Popular Badge */}
              {plan.highlight && (
                <div className="absolute top-6 right-6 px-4 py-2 rounded-full bg-cyan-400 text-black text-xs font-black uppercase tracking-wider">
                  Most Popular
                </div>
              )}
              ...
              <div className="space-y-5 mb-10">
                {plan.features.map((feature) => (
                  ...
                  >
                    <div className="w-6 h-6 rounded-full bg-cyan-400/10 border border-cyan-400/20 flex items-center justify-center text-cyan-300 text-sm">
                      ✓
                    </div>
